...
Revision ID: a00103c0c9a8
Revises: 06305bd8af09
Create Date: 2025-10-25 20:46:19.717738
...
revision = 'a00103c0c9a8'
down_revision = '06305bd8af09'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.PrimaryKeyConstraint('user_id', name=op.f('users_table_pkey')),
    sa.UniqueConstraint('email', name=op.f('users_table_email_key')),
    sa.UniqueConstraint('username', name=op.f('users_table_username_key'))
    )
